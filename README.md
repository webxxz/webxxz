...
## 🔍 **SubdomainScanner (Public)**
✔ subfinder + amass + crt.sh  
✔ Real-time HTTP probing  
✔ Banner grabbing  
✔ Live/Dead domain filtering  
✔ CSV output  

---

## 🦂 **RedWraith – Real-Time Red Team Automation Platform**
- Recon modules  
- Auth bypass modules  
- SQLi/XSS/SSRF/LFI exploitation  
- Live dashboard (SocketIO)  
- Gemini AI-based attack logic  
- Docker microservice  

---

## 🪝 **OOB Security Testing Framework**
- Auto-crawling + payload injection  
- interact.sh verification  
- JSON/POST body exploitation  
- Multi-threaded  
- CSV/JSON reporting  

---

## 💉 **SQL Injection Automation Suite**
✔ URL discovery  
✔ Reflection detection  
✔ GET/POST form testing  
✔ sqlmap automation  
✔ nuclei CVE scanning  
✔ dalfox + kxss + gf patterns  
...
<picture>
  ...
  <img src="https://github-readme-streak-stats.herokuapp.com?user=webxxz" />
</picture>
...
<div align="center">
  <img src="https://github-profile-trophy.vercel.app/?username=webxxz&theme=algolia&margin-w=10&margin-h=10">
</div>
